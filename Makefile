...
compiler_moc_header_make_all: moc_FlickCharm.cpp moc_QDetroBro.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_FlickCharm.cpp moc_QDetroBro.cpp 2> NUL
...
moc_QDetroBro.cpp: ui_QDetroBro.h \
		QDetroBro.h \
		..\..\..\..\Qt\4.5.2-tower\bin\moc.exe
...
compiler_uic_make_all: ui_QDetroBro.h
compiler_uic_clean:
	-$(DEL_FILE) ui_QDetroBro.h 2> NUL
ui_QDetroBro.h: QDetroBro.ui
	c:\Qt\4.5.2-tower\bin\uic.exe QDetroBro.ui -o ui_QDetroBro.h
